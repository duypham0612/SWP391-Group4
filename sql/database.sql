...
-- Việt Nam không có DST, nên cộng cố định UTC+7; tránh AT TIME ZONE vốn không
-- được Azure SQL Edge hỗ trợ trong môi trường Docker của dự án.
...
/* ===========================================================================
   PART E) DEMO KDS — SIZE & MODIFIER (ZT1–ZT4)

   Chỉ chạy khi chủ động đặt @SeedDemo = 1 ở đầu file database.sql.
   Khi deploy bình thường (@SeedDemo = 0), PART 8 bật SET NOEXEC nên toàn bộ
   dữ liệu demo, bao gồm phần này, được bỏ qua. Không chạy riêng phần này.
   =========================================================================== */
SET NOCOUNT ON;
SET XACT_ABORT ON;
