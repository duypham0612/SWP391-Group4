...
<head>
    ...
    <style>
        ...
        /* Thay thế :has() bằng class .active do JS kích hoạt */
...
<script>
    function syncServiceTags() {
        // Cập nhật hiệu ứng màu sắc (active class) thay thế cho thuộc tính CSS :has()
        ...
        // Xử lý logic gộp chuỗi các tag đã chọn
