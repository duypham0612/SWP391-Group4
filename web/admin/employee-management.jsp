...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', sans-serif; }
        body { background-color: var(--bg-color); color: var(--text-color); padding: 30px; }
        ...
        .header h2 { color: var(--primary-color); font-size: 24px; }
        ...
        .table-section { width: 100%; border-collapse: collapse; margin-top: 15px; }
        .table-section th { background-color: #F9F9F9; color: #555; padding: 14px; text-align: left; border-bottom: 2px solid var(--border-color); }
        .table-section td { padding: 14px; border-bottom: 1px solid var(--border-color); vertical-align: middle; }
        .table-section tr:hover { background-color: #FBFBFA; }

        .role-form { display: inline-flex; align-items: center; gap: 8px; }
        .select-role { 
            padding: 6px 12px; 
            border-radius: 20px; 
        ...
        .select-role:focus { border-color: var(--primary-color); background: #FFF; }
        ...
        .btn-save-role:hover { color: var(--primary-color); }

        .status-on { color: #2ECC71; font-weight: bold; }
        .status-off { color: #E74C3C; font-weight: bold; }
        
        .actions a { color: #555; margin-right: 12px; text-decoration: none; font-size: 16px; }
        ...
        .modal-header h3 { color: var(--primary-color); font-size: 20px; font-weight: 700; }
        .modal-close-btn { background: none; border: none; font-size: 20px; cursor: pointer; color: #aaa; }
        ...
        .modal-footer { display: flex; justify-content: flex-end; gap: 10px; margin-top: 22px; padding-top: 10px; }
        .btn-close { background: #E5E5E5; color: #444; border: none; padding: 10px 16px; border-radius: 5px; cursor: pointer; font-weight: 600; }
        .btn-submit-form { background: var(--primary-color); color: var(--white); border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-weight: 600; }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <c:if test="${param.success != null}">
            <div style="background: #e6ffe6; color: #006400; padding: 12px; border-radius: 6px; margin-bottom: 20px;">
        ...
        <c:if test="${param.error != null}">
            <div style="background: #fee; color: #c00; padding: 12px; border-radius: 6px; margin-bottom: 20px;">
                ...
                ${param.error == 'missingFields' ? 'Vui lòng nhập đầy đủ thông tin (Tên, Email, Mật khẩu, Chức vụ)' : 
                  param.error == 'insertFailed' ? 'Không thể thêm nhân viên. Email có thể đã tồn tại.' :
