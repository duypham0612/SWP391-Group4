...
public class LoginController extends HttpServlet {
     ...
     * RoleID theo DB: 1 = Admin, 2 = Branch Manager, 3 = Cashier, 4 = Barista, 5 = Customer
     *
     * PHÂN QUYỀN:
     *   - RoleID 1, 2, 3, 4 → Trang quản trị/nhân viên (admin, manager, POS, kitchen)
    ...
    private void redirectByRole(int roleId, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        switch (roleId) {
            ...
            case 2: // Branch Manager — Quản lý chi nhánh
                ...
                break;
            case 3: // Cashier & Inventory Staff — Thu ngân & Kho
                response.sendRedirect(contextPath + "/pos-tables");
                break;
            case 4: // Barista — Pha chế
                response.sendRedirect(contextPath + "/kitchen"); // Hoặc trang order list của pha chế
                break;
