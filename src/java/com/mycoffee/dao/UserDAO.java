...
public class UserDAO {
    ...
    /**
     * Đăng ký tài khoản mới cho Khách hàng. BẢO MẬT: RoleID được SET CỨNG = 4
     * (Customer) tại đây.      * <<<<<<< HEAD
=======
     * Tuyệt đối KHÔNG nhận RoleID từ phía client truyền lên.
     * >>>>>>> master Sau khi insert Users thành công, tự động insert bản ghi
     * vào bảng Customers để kích hoạt tính năng tích điểm. Toàn bộ thực hiện
     * trong 1 TRANSACTION.
     */
