...
public class UserDAO {
    ...
    // Hàm Đăng ký tài khoản khách hàng (Dùng Transaction liên kết bảng Users và Customers)
    public boolean registerUser(User user) {
        ...
        try {
            ...
            try (PreparedStatement psUser = conn.prepareStatement(sqlInsertUser, Statement.RETURN_GENERATED_KEYS)) {
                ...
                psUser.setInt(6, CUSTOMER_ROLE_ID); 
            ...
            if (newUserId == -1) { conn.rollback(); return false; }
    ...
    // --- BỔ SUNG: Hàm thay đổi trạng thái hoạt động khóa/mở tài khoản ---
