...
<%-- Thứ tự ưu tiên thị giác: tên món + số lượng → ghi chú → bàn/mã đơn.
...
<div class="kds-card__identity">
    ...
    <div class="kds-meta-row"><span>${cardItem.orderTypeLabel} · Đơn #${cardItem.orderId} · vào lúc ${cardItem.createdDisplay}</span></div>
</div>
