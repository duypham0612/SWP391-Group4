...
<article class="card kds-card kds-${peakMode ? 'ok' : cardItem.slaTier}" data-kds-item-id="${cardItem.orderItemId}" data-owner="unassigned" data-station="${cardItem.station}" data-order-type="${cardItem.orderType}" data-priority="${cardItem.priority}" data-sla-tier="${cardItem.slaTier}">
