...
<div class="page-header">
    <div><h1>Gán modifier: ${product.name}</h1><p>catalog.ProductModifierGroup</p></div>
    <a class="btn btn-ghost" href="${ctx}/admin/product">← Quay lại sản phẩm</a>
</div>

<div class="card" style="margin-bottom:18px">
    <h3 style="margin-top:0">Gán nhóm modifier cho sản phẩm</h3>
    <form action="${ctx}/admin/modifier" method="post" style="display:flex;gap:12px;align-items:flex-end;flex-wrap:wrap">
        ...
        <div class="form-group" style="margin:0;flex:1;min-width:240px">
            <label for="groupId">Nhóm modifier</label>
...
<c:choose>
    <c:when test="${empty assigned}">
        <div class="card empty-state"><div class="icon">🎚️</div><p>Sản phẩm chưa gán nhóm modifier nào.</p></div>
    </c:when>
    <c:otherwise>
        <table class="table">
            <thead><tr><th>Nhóm modifier đã gán</th><th style="width:120px">Bỏ gán</th></tr></thead>
            <tbody>
