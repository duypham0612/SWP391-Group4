...
<c:choose>
    ...
    <c:otherwise>
        <table class="table">
            <thead><tr><th style="width:60px">#</th><th>Nhà cung cấp</th><th style="width:130px">Trạng thái</th><th style="width:150px">Tổng tiền</th><th>Người nhập</th><th style="width:100px"></th></tr></thead>
            <tbody>
