...
final class BillingRepository {
    ...
    final VoucherRedemptionDao voucherRedemptionDao;

    BillingRepository() {
        this(new BillDao(), new BillLineDao(), new CashierShiftDao(), new OrderItemDao(), new OrderItemQueryDao(),
                new OrderItemModifierDao(),
                new DiningTableDao(), new OrderDao(), new OutboxEventDao(), new VoucherRedemptionDao());
    }
    ...
    BillingRepository(BillDao billDao, BillLineDao billLineDao, CashierShiftDao cashierShiftDao,
                      ...
                      OutboxEventDao outboxEventDao, VoucherRedemptionDao voucherRedemptionDao) {
        ...
        this.voucherRedemptionDao = java.util.Objects.requireNonNull(voucherRedemptionDao);
    }
