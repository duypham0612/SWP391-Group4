...
public final class OrderService {
    ...
    public List<ProductRecipe> getRecipeIngredients(int p)throws SQLException{return query.getRecipeIngredients(p);} public List<ProductRecipe> getDepletedRecipeIngredients(int b,int p)throws SQLException{return query.getDepletedRecipeIngredients(b,p);}
    ...
    public List<PickupTicket> getPickupTickets(int b)throws SQLException{return query.getPickupTickets(b);} public Order getOrder(int o)throws SQLException{return query.getOrder(o);} public List<Order> getIncomingOrders(int b)throws SQLException{return query.getIncomingOrders(b);} public List<Order> getSessionOrders(int s)throws SQLException{return query.getSessionOrders(s);}
}
